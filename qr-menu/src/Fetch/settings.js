...
export const TABLES_DELETE = (type, table_number) => CONCATE + `delete/tables?type=${type}&table_number=${table_number}`
...
export const CATEGORY_DELETE = (type, category_id) => CONCATE + `delete/categories?type=${type}&category_id=${category_id}`

export const DISH_ADD = CONCATE + "add/dish"
export const DISH_GET = CONCATE + "get/dish"
export const DISH_DELETE = (dish_id, category_id) => CONCATE + `delete/dish?dish_id=${dish_id}&category_id=${category_id}`

export const INGREDIENTS_ADD = CONCATE + "add/ingredient"
export const INGREDIENTS_GET = CONCATE + "get/ingredients"
export const INGREDIENTS_DELETE = (ingredient_id, dish_id) => CONCATE + `delete/ingredients?ingredient_id=${ingredient_id}&dish_id=${dish_id}`